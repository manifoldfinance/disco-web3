...
describe('Fraction', () => {
  ...
  describe('#absoluteValue', () => {
    it('returns the absolute value of fraction with negative denominator', () => {
      expect(
        new Fraction(JSBI.BigInt(5), JSBI.BigInt(-10)).absoluteValue()
          .denominator,
      ).toEqual(JSBI.BigInt(10));
    });
    ...
    it('returns the absolute value of fraction with negative numerator and denominator', () => {
      const absFraction = new Fraction(
        JSBI.BigInt(-5),
        JSBI.BigInt(-10),
      ).absoluteValue();
  ...
  describe('#lessThanOrEqualTo', () => {
    it('correct', () => {
      expect(
        new Fraction(JSBI.BigInt(1), JSBI.BigInt(10)).lessThanOrEqualTo(
          new Fraction(JSBI.BigInt(4), JSBI.BigInt(12)),
        ),
      ).toBe(true);
      expect(
        new Fraction(JSBI.BigInt(1), JSBI.BigInt(3)).lessThanOrEqualTo(
          new Fraction(JSBI.BigInt(4), JSBI.BigInt(12)),
        ),
      ).toBe(true);
      expect(
        new Fraction(JSBI.BigInt(5), JSBI.BigInt(12)).lessThanOrEqualTo(
          new Fraction(JSBI.BigInt(4), JSBI.BigInt(12)),
        ),
      ).toBe(false);
    });
  ...
  describe('#greaterThanOrEqualTo', () => {
    it('correct', () => {
      ...
      expect(
        new Fraction(JSBI.BigInt(1), JSBI.BigInt(3)).greaterThanOrEqualTo(
          new Fraction(JSBI.BigInt(4), JSBI.BigInt(12)),
        ),
      ).toBe(true);
      expect(
